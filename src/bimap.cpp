...
const boost::bimap<Operation, Byte>& construct_bimap() {
	static const boost::bimap<Operation, Byte> bimap = [] {
		...
		bm.insert({ {"ADC", ABSOLUTE}, INS_ADC_ABS });
		...
		bm.insert({ {"AND", ABSOLUTE}, INS_AND_ABS });
		...
		bm.insert({ {"ASL", ABSOLUTE}, INS_ASL_ABS });
		bm.insert({ {"BCC", RELATIVE}, INS_BCC });
		bm.insert({ {"BCS", RELATIVE}, INS_BCS });
		bm.insert({ {"BEQ", RELATIVE}, INS_BEQ });
		bm.insert({ {"BIT", ZERO_PAGE}, INS_BIT_ZP });
		bm.insert({ {"BIT", ABSOLUTE}, INS_BIT_ABS });
		bm.insert({ {"BMI", RELATIVE}, INS_BMI });
		bm.insert({ {"BNE", RELATIVE}, INS_BNE });
		bm.insert({ {"BPL", RELATIVE}, INS_BPL });
        bm.insert({ {"BRK", IMPLIED }, INS_BRK });
        bm.insert({ {"BVS", RELATIVE}, INS_BVS });
        ...
        bm.insert({ {"EOR", ABSOLUTE}, INS_EOR_ABS });
        ...
        bm.insert({ {"LDX", ABSOLUTE}, INS_LDX_ABS });
        ...
        bm.insert({ {"LDY", ABSOLUTE}, INS_LDY_ABS });
        ...
        bm.insert({ {"LSR", ABSOLUTE}, INS_LSR_ABS });
        ...
        bm.insert({ {"ORA", ABSOLUTE}, INS_ORA_ABS });
        ...
        bm.insert({ {"ROL", ABSOLUTE}, INS_ROL_ABS });
        ...
        bm.insert({ {"ROR", ABSOLUTE}, INS_ROR_ABS });
        ...
        bm.insert({ {"SBC", ABSOLUTE}, INS_SBC_ABS });
        ...
        bm.insert({ {"STA", ABSOLUTE}, INS_STA_ABS });
